...
DESCRIPTION="${DESCRIPTION:-Updated at $(date)}"
...
cd chaos-mesh && gopages -brand-title ${TITLE} -brand-description ${DESCRIPTION} -base https://chaos-mesh.dev/godoc/$TARGET_BRANCH_OR_TAG -out $OUT_DIRECTORY
